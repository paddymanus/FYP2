...
public class StatsMeasurementsActivity extends AppCompatActivity implements StatsHomeRecyclerAdapter.OnStatsHomeListener, View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stats_measurements);
    ...
    private void insertStats(){
        StatsHome statsHome = new StatsHome("Body measurements list");
    ...
    public void onStatClicked(int position) {
        if(position == 0){
            ...
            Intent intent = new Intent(this, StatsAddMeasurementActivity.class);
